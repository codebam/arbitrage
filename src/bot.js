...
const ARBITRAGE_CONTRACT_ADDR = "0x199008ACC77Dc799777fEf9ae60E7Fb9C4C54ef3";
...
if (uniswap_price > pancakeswap_price) {
    result = await doArbitrage(100000000000000n, false);
} else {
    result = await doArbitrage(100000000000000n, true);
}
