...
const ARBITRAGE_CONTRACT_ADDR = "0x36cb1be4e1f955a323380b3df42c81e2d1b182a8";
...
async function doArbitrage(amount, startOnUniswap) {
  console.log("Contract Address:", ARBITRAGE_CONTRACT_ADDR);
  console.log("PoolKey:", pKey);
  const { request } = await client.simulateContract({
    ...
    args: [amount, WETH_ADDR, USDC_ADDR, startOnUniswap, pKey],
  });
...
if (uniswap_price > pancakeswap_price) {
  result = await doArbitrage(1000000000000000000n, false);
} else {
  result = await doArbitrage(1000000000000000000n, true);
}
