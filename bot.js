...
const pQuoteAddress = '0xB048Bbc1Ee6b733FFfCFb9e9CeF7375518e25997'

const ethers = require("ethers")
const config = require('./config.json')
const { getTokenAndContract, getPairContract, getV3Price, getQuote } = require('./helpers/helpers.js')
const { alchemy, uFactory, uRouter, pFactory, pRouter, arbitrage } = require('./helpers/initialization.js')

let uPair, pPair, amount, uRate, pRate, price, uPrice, pPrice, attempts=0, success=0
...
const main = async () => {
  ...
  console.log(`This is the price on Pancakeswap: ${pPrice} ${token1.symbol}/${token0.symbol}`)
